...
// Description: NR Sidelink Scheduler supporting Dynamic MCS and 2D resource scheduling
//              This class extends the functionality of NrSlUeMacSchedulerFixedMcs 
//              to support dynamic MCS adaptation and 2D resource scheduling.

#ifndef NR_SL_UE_MAC_SCHEDULER_DYNAMIC_MCS_H
#define NR_SL_UE_MAC_SCHEDULER_DYNAMIC_MCS_H
 ...
 */
class NrSlUeMacSchedulerDynamicMcs : public NrSlUeMacScheduler
{
  public:
    /**
     * \brief GetTypeId
    ...
    /**
     * \brief NrSlUeMacSchedulerDynamicMcs default constructor
     */
    NrSlUeMacSchedulerDynamicMcs();

    /**
     * \brief NrSlUeMacSchedulerDynamicMcs destructor
     */
    ~NrSlUeMacSchedulerDynamicMcs() override;
  ...
  protected:
     ...
     */
    virtual uint32_t CalculateTbSize(Ptr<const NrAmc> nrAmc,
                             uint8_t dstMcs,
  ...
  private:
    ...
    bool IsResourceOverlapped(const std::list<SlResourceInfo>& resources,
                        const SlResourceInfo& candidate) const;
    ...
    std::list<SlResourceInfo> SelectResourcesForBlindRetransmissions2D(
        std::list<SlResourceInfo> txOpps);
...
#endif /* NR_SL_UE_MAC_SCHEDULER_DYNAMIC_MCS_H */
